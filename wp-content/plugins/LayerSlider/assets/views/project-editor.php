														...
														<lse-row>
															...
															<lse-col>
																...
																<lse-ib class="lse-jcc">
																	<lse-button class="lse-assets-library-button" data-asset-for="slide-image">
													...
													<lse-grid class="lse-form-elements">
														<lse-row>
															...
															<lse-col class="lse-img-type-only">
																...
																<lse-ib class="lse-jcc">
																	<lse-button class="lse-assets-library-button" data-asset-for="layer-image">
																		<?= __('Choose Asset', 'LayerSlider') ?>
																	</lse-button>
																</lse-ib>
															</lse-col>
															...
															<lse-col class="lse-object-type-only">
																<lse-ib class="lse-half lse-jcc">
																	<lse-button class="lse-giant lse-aic lse-assets-library-button" data-asset-for="layer-svg" data-asset-category="maps-flags">
																		<?= lsGetSVGIcon('photo-video')?>
																		<lse-text>
																		<?= __('Choose Asset', 'LayerSlider') ?>
																		</lse-text>
													...
													<lse-grid class="lse-form-elements">
														<lse-row>
															...
															<lse-col>
																...
																<lse-ib class="lse-jcc">
																	<lse-button class="lse-assets-library-button" data-asset-for="layer-background-image">
																		<?= __('Choose Asset', 'LayerSlider') ?>
																	</lse-button>
																</lse-ib>
															</lse-col>
