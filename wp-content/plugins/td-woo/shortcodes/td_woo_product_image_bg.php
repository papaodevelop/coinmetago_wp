 ...
 */
class td_woo_product_image_bg extends td_block {
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
                ...
                /* @general */
                .$unique_block_class .tdw-product-image-bg {
                ...
                .$unique_block_class .tdw-product-image-bg:after,
                .$unique_block_class .tdw-product-image-bg:before,
                .$unique_block_class:after {
                    border-radius: 100%;
                }
                ...
                /* @img_static */
                html:not(.td-md-is-ios):not(.td-md-is-android)  .$unique_block_class .tdw-product-image-bg {
                ...
                @media (min-width: 1141px) {
                    ...
                    .$unique_block_class:hover .tdw-product-image-bg:after {
                        opacity: 1;
                    }
                }
                ...
                /* @mix_type_off */
                .$unique_block_class .tdw-product-image-bg:hover:before {
                    opacity: 0;
                }
                ...
                /* @effect_on_h */
                @media (min-width: 1141px) {
                    .$unique_block_class.tdw-product-image-bg:hover {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        $tdw_image_size = $res_ctx->get_shortcode_att( 'image_size' );
        $post_featured_image = $td_woo_state_single_product_page->product_image_bg->__invoke($tdw_image_size);
    ...
    function render($atts, $content = null) {
        ...
        $buffy .= '<div class="' . $this->get_block_classes()  . '" ' . $this->get_block_html_atts() . '>';
            ...
            $buffy .= '<div class="tdw-product-image-bg"></div>';
